import type {Event, RawDate} from "$lib/types";
import {randomNumber, randomString} from "$lib/utils";
import {randomDate} from "$lib/date-utils";
...
for (let i = 1; i < 13; i++) {
    ...
    fakeEvents.push(
        ...
        id: 10 + i,
        name: {
            fr: `Exemple #${i.toString().padStart(2, '0')}`,
            en: `Exemple #${i.toString().padStart(2, '0')}`,
            de: `Exemple #${i.toString().padStart(2, '0')}`,
        },
        seo: {
            name: {
